...
public class GangBlurb1 : ConversationBase
{
    public GangBlurb1(
        Text _NPCText,
        Text _PlayerText1,
    ...
    public override void Part1()
    {
        if (Globals.InGang)
        {
            NPCText.text = "Why are you coming back before you've sold anything? We can't meet too much. Do you want to get caught?";
            Reading(EndConversation);
        }
        else if (Globals.KnowsAboutGang)
        {
            NPCText.text = "Do you want to join now?";
            PlayerText1.text = "Yes.";
            PlayerText2.text = "No.";
            Choosing(Part11h, Part101);
        }
        else
        {
            NPCText.text = "Are you interested in the oppurtunity now?";
            PlayerText1.text = "No.";
            PlayerText2.text = "Yes.";
            Choosing(Part101, Part3b);
        }
    }

    void Part101()
    {
        NPCText.text = "Then why did you come back? I have work to do.";
        Reading(EndConversation);
    }
